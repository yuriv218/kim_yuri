			  ...
			  <div class="col-lg-12"> 
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">매출액 관련</strong>
                            </div>
                            <div class="card-body" >
                            <span style="font-size: 12px;float: right;"><i class="fa fa-check-square-o"></i>종합소득금액이 6천만원 이하인 무주택자로서, 국민주택규모이하(85㎡)이거나 기준시가(3억원)이하 주택을 월세로 임차중이신 분만 해당됩니다.</span> 
                            
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body" style="background-image: url('images/cc.jpg'); background-repeat: no-repeat; background-position: 50% 50%;">
                                      <form action="rent_benefit.do" id="_ff" name="_ff" class="_ff">
                                     
                                            <div class="form-group" style="padding-bottom: 30px">  
                                            <i class="pe-7s-help1" style="color: #FF6347"></i>&nbsp;&nbsp;<label for="cc-payment" class="control-label mb-1">다음 중 귀하의 종합소득금액 구간은 어떻게 되나요?</label>
                                             
                                           	 	<div class="col col-md-6"> 
                                       		    <div class="form-check-inline form-check">
	                                                <label for="inline-radio1" class="form-check-label ">
	                                                    <input type="radio" id="inline-radio1" name="sales" value="4천만원 이하" class="form-check-input" checked="checked">4천만원 이하 &nbsp;&nbsp;
	                                                </label>
	                                                <label for="inline-radio2" class="form-check-label ">
	                                                    <input type="radio" id="inline-radio2" name="sales" value="4천만원 초과" class="form-check-input">4천만원 초과 ~ 6천만원 이하 &nbsp;&nbsp;
	                                                </label> 
                                                </div>
                                  			 	</div>
                                             </div>
                                             ...
                                             <div class="form-group" style="padding-bottom: 30px"> 
                                            <i class="pe-7s-help1" style="color: #FF6347"></i>&nbsp;&nbsp;<label for="cc-payment" class="control-label mb-1">자택 월세는 얼마인가요?</label>
                                             
                                           	 	<div class="col col-md-6"> 
                                       			 	<div class="input-group">
                                           				<input type="text" id="input2-group2" name="rentM" placeholder="자택 월세" class="form-control" numberonly="true">
