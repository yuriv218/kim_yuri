			...
			<div class="animated fadeIn">
			  <div class="col-lg-12"> 
                        <div class="card">
                            ...
                            <div class="card-body" >
                            <span style="font-size: 12px;float: right;"><i class="fa fa-check-square-o"></i>연간 매출액 5억이상 500억 이하 사업주만 해당됩니다.</span> 
                            
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body" style="background-image: url('images/cc.jpg'); background-repeat: no-repeat; background-position: 50% 50%;">
    
                                      <form action="car_benefit.do" id="_ff" name="_ff" class="_ff">
                                            <div class="form-group" style="padding-bottom: 30px">  
                                            <i class="pe-7s-help1" style="color: #FF6347"></i>&nbsp;&nbsp;<label for="cc-payment" class="control-label mb-1">월 평균 매출액은 얼마나 되나요?</label>
                                             
                                           	 	<div class="col col-md-6"> 
                                       			 	<div class="input-group">
                                           				<input type="text"  id="_sales" name="sales" placeholder="매출액 입력" class="form-control" numberonly="true">
                                             ...
                                             <div class="form-group" style="padding-bottom: 30px"> 
                                            <i class="pe-7s-help1" style="color: #FF6347"></i>&nbsp;&nbsp;<label for="cc-payment" class="control-label mb-1">전체 매출액 중 신용카드 결제 비중은 얼마나 되나요?</label>
                                             
                                           	 	<div class="col col-md-6"> 
                                       			 	<div class="input-group">
                                           				<input type="text" id="_percentage" name="percentage" placeholder="비율 입력" class="form-control" numberonly="true">
                                           		 		<div class="input-group-btn"><button class="btn btn-primary" style="background-color: #FF8C00; border-color: #FF8C00">%</button></div>
                                       				</div>
                                  			 	 </div>
                                             </div>
                                            </form>	
