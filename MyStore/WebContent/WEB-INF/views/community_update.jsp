					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<form id="frm" action="communityUpdateAf.do" method="post">
									<table width="100%">
										<tr>
											<td width="150px"
											...
											<td>
												...
												value="${bbs.category }" /> <input type="hidden" name="seq"
										...
										<tr>
											...
											<td><textarea rows="10" cols="30" id="ir1"
													name="content"
													style="width: 766px; height: 412px; padding-bottom: 20px">${bbs.content }</textarea>
