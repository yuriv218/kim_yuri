			  ...
			  <div class="col-lg-12"> 
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">교육비 세액공제 관련</strong>
                            </div>
                            <div class="card-body" >
                            <span style="font-size: 12px;float: right;"><i class="fa fa-check-square-o"></i>교육비 세액공제는 소득세법상 성실 사업자 또는 성실신고확인대상자로서 <a href="https://www.nts.go.kr/support/support_01.asp?cinfo_key=MINF7720180427103655&menu_a=10&menu_b=0&menu_c=0"><u>'성실신고확인서'</u></a>를 제출 예정 이신 분만 해당됩니다.</span> 
                                      
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body" style="background-image: url('images/cc.jpg'); background-repeat: no-repeat; background-position: 50% 50%;">
										<form action="study_benefit.do" id="_ff" name="_ff" class="_ff">
										
										
                                            <div class="form-group" style="padding-bottom: 30px"> 
                                            <i class="pe-7s-help1" style="color: #FF6347"></i>&nbsp;&nbsp;<label for="cc-payment" class="control-label mb-1">작년에 지출하신 본인 교육비용(부양가족 제외)은 얼마나 되나요?</label>
                                             
                                           	 	<div class="col col-md-6"> 
                                       			 	<div class="input-group">
                                           				<input type="text" id="input2-group2" name="edu" placeholder="교육비" class="form-control" numberonly="true">
                                           		 		<div class="input-group-btn"><button class="btn btn-primary" style="background-color: #FF8C00; border-color: #FF8C00">만원</button></div>
                                       				</div>
                                  			 	 </div>
                                             </div>
                                         ...
                                         <col width="200px"><col>
				                            <thead>
				                                <tr align="center">
				                                    <th scope="col">분류</th>
				                                    <th scope="col">공제 대상 교육비</th>
				                                </tr>
				                            </thead> 
				                            <tbody>
				                                <tr>
				                                    <td align="center">일반 교육비</td>
				                                    <td>
				                                                                   ㆍ대학원 교육비 <br>
								                                    ㆍ대학(원격대학 및 학위취득과정 포함)<br>
								                                    ㆍ직업능력개발훈련수강료(근로자 직업능력 향상 지원금은 차감)  
				                                    </td>
				                                  
				                                </tr>
				                                <tr>
				                                    <td align="center">장애인 특수 교육비</td>
				                                    <td>
				                                                                     장애인 재활교육을 위하여 아래의 기관 등에 지급하는 특수교육비<br>
													ㆍ일정한 사회복지시설 및 비영리법인 및 이와 유사한 외국에 있는 시설 또는 법인<br>
													ㆍ장애인의 기능향상과 행동발달을 위한 발달재활서비스를 제공하는 기관<br>
													</td>
