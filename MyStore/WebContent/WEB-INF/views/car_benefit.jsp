                            ...
                            <div class="card-header">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body" style="background-image: url('images/cc.jpg'); background-repeat: no-repeat; background-position: 50% 80%;">
                                     	...
                                     	<span style="font-size: 12px">카드 수수료 인하 혜택으로<br></span> 
                                     	<span style="font-size: 18px; font-weight: bolder;">연간 <span style="font-size: 24px;color: #FF8C00">${M_result.resultY }원</span> 혜택<br></span>
                                     </div>
                                     
                                      <span style="font-size: 12px;float: right;">ㆍ매출액:  ${sales }만원 &nbsp;&nbsp;&nbsp;&nbsp;ㆍ신용카드 결제 비중:  ${percentage }% </span>  
                                    
                                     <c:choose>
                                  
                                     <c:when test="${M_result.resultY eq '0'}">
                                   	  <div style="padding-top: 50px" align="center">
                                     	<span style="font-size: 18px;">조건에 해당되지 않습니다.</span>
                                      </div> 
                                     </c:when>
                                     
                                     <c:otherwise>
                                      <div style="padding-top: 50px" align="center">
                                     	<span style="font-size: 18px;">월 평균 <span style="font-weight: bolder;">${M_result.commAnswer }원</span>에서 <span style="font-weight: bolder;">${M_result.commAnswerNow }원</span>으로 <span style="font-weight: bolder;">${M_result.result }원</span> 인하 <br></span>
                                      </div>
                                     </c:otherwise>
                              	 	  ...
                              	 	  <div style="background-color:#F5F5F5;margin-top: 40px">
	                              	 	<span style="font-size: 15px;">&nbsp;카드수수료 인하 혜택<br></span>
	                              	 	<span style="font-size: 12px;">&nbsp;신용카드 우대수수료 범위 확대 및 수수료 인하 정책으로 연매출 5억~10억 이하는 2.05%~1.4%로 <br>
	                              	 		&nbsp; 10억~30억 이하는 2.21%~1.6% 로 30억~500억 이하는 2.2%~2%로 수수료가 적용됩니다.
	                              	 	</span>  
                              	      </div>
