											...
											<div class="card-body card-block">
												...
												<div class="row form-group">
													...
													<div class="col-12 col-md-9">
														<p class="form-control-static">${login.id}</p>
													</div>
												</div>
												<div class="row form-group">
													<div class="col col-md-3">
													...
													<div class="col-12 col-md-9">
														<input type="text" id="text-input" name="title"
															class="form-control" value="${qna.title }">
													</div>
												</div>
												...
												<a href="qnadetail.do" id="_btnUpdate" title="글수정하기"
													class="btn btn-success">돌라가기</a>
