...
<body>
    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="content">
			...
			<img alt="" src="images/calImage.jpg">
			</div>
		    <div class="row">

		      <div class="col-lg-3 col-md-6" onclick="location.href ='calculator_card.do'" style="cursor:pointer">
                        <div class="card"> 
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">카드 수수료 인하 혜택</div> 
                                            <div class="stat-heading">※매출액 관련 문항 입력</div>
                                        </div> 
                                    </div>  
                                </div>
                            </div> 
                ...
                <div class="col-lg-3 col-md-6" onclick="location.href ='calculator_people.do'" style="cursor:pointer">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-1">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">일자리 안정자금 혜택</div> 
                                            <div class="stat-heading">※인건비 관련 문항 입력</div>
                                        </div> 
                                    </div> 
                                </div>
                            </div> 
               ...
               <div class="col-lg-3 col-md-6" onclick="location.href ='calculator_rent.do'" style="cursor:pointer">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-1">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">월세 세액공제 혜택</div> 
                                            <div class="stat-heading">※월세 관련 문항 입력</div>
                                        </div> 
                                    </div> 
                                </div>
                            </div> 
               ...
               <div class="col-lg-3 col-md-6" onclick="location.href ='calculator_study.do'" style="cursor:pointer">
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-five">
                                    <div class="stat-icon dib flat-color-1">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">교육비 공제 혜택</div> 
                                            <div class="stat-heading">※교육비 관련 문항 입력</div>
                                        </div> 
                                    </div> 
                                </div>
                            </div> 
