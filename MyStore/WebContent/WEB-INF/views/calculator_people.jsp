			  ...
			  <div class="col-lg-12"> 
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">근로자  관련</strong>
                            </div>
                            <div class="card-body" >
                            <span style="font-size: 12px;float: right;"><i class="fa fa-check-square-o"></i>인건비 부담완화 계산은 월 급여 (175만원 ~ 210만원) 상용근로자(주당 40시간 이상 가정)를 고용하신 분만 해당됩니다.</span> 
                             
                                <!-- Credit Card -->
                                <div id="pay-invoice">
                                    <div class="card-body" style="background-image: url('images/cc.jpg'); background-repeat: no-repeat; background-position: 50% 50%;">

                                    <form action="people_benefit.do" id="_ff" name="_ff" class="_ff">
                                     
                                            <div class="form-group" style="padding-bottom: 30px">  
                                            <i class="pe-7s-help1" style="color: #FF6347"></i>&nbsp;&nbsp;<label for="cc-payment" class="control-label mb-1">운영 중인 사업장의 종사자 수는 어떻게 되나요?</label>
                                             
                                           	 	<div class="col col-md-6"> 
                                       		    <div class="form-check-inline form-check">
	                                                <label for="inline-radio1" class="form-check-label ">
	                                                    <input type="radio" id="inline-radio1" name="peopleN" value="5인 미만" class="form-check-input" checked="checked">5인 미만 &nbsp;&nbsp;
	                                                </label>
	                                                <label for="inline-radio2" class="form-check-label ">
	                                                    <input type="radio" id="inline-radio2" name="peopleN" value="5~10인 미만" class="form-check-input">5~10인 미만 &nbsp;&nbsp;
	                                                </label> 
	                                                <label for="inline-radio3" class="form-check-label ">
	                                                    <input type="radio" id="inline-radio3" name="peopleN" value="10~30인 미만" class="form-check-input">10~30인 미만&nbsp;&nbsp;
	                                                </label>
                                                </div>
                                  			 	</div>
                                             </div>  
                                             ...
                                             <div class="form-group" style="padding-bottom: 30px"> 
                                            <i class="pe-7s-help1" style="color: #FF6347"></i>&nbsp;&nbsp;<label for="cc-payment" class="control-label mb-1">월 급여 175만원 이상 210만원 이하인 상용근로자(주당 40시간 이상 근무)는 몇 명인가요?</label>
                                             
                                           	 	<div class="col col-sm-3">  
                                       			 	<div class="input-group"> 
                                       			 	
                                           				<input type="text" id="input2-group2" name="peopleM" placeholder=""  class="form-control" numberonly="true">
                                           		 		<div class="input-group-btn"><button class="btn btn-primary" style="background-color: #FF8C00; border-color: #FF8C00">명</button></div>
                                       				</div>
                                  			 	 </div>
                                             </div>
      								   </form>
			   ...
			   <div align="center"> <button type="button" class="btn btn-secondary" onclick="goBack()">이전</button>
				      <button id="gogo" type="button" class="btn btn-warning" style="background-color: #FF8C00">                                                  
				          <span id="payment-button-amount" style="color: white;">계산하기</span>                                     
				      </button>
			   </div>
