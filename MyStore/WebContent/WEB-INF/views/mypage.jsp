				...
				<div class="row">
					<div class="col-lg-8">
						<div class="card">
							...
							<div id="cardinfo">
								<div class="card-body">
									                <form name="frmForm" id="_frmForm" method="post" action="mypageUpdate.do">
                                       ...
                                       <div class="col-6"><label for="id" class=" form-control-label">아이디</label>
                                       ...
                                       <input type="text" name="phone" id="_phone" class="form-control" readonly="readonly" value="${mem.phone }"><br>
                                       ...
                                       <div class="col-6"><label for="store" class=" form-control-label">매장이름</label>
                                       ...
                                       <textarea rows="3" name="detail" id="_detail" class="form-control" readonly="readonly">${mem.detail }</textarea>
                                       	</div>
                                ...
                                <a href="mypageUpdate.do?id=${mem.id }" class="btn btn-success">정보수정</a>
                                <a href="passwordChange.do" class="btn btn-success">비밀번호 변경 </a>
                                </form>
								</div>
