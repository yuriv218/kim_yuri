                        ...
                        <div class="card">
                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="bootstrap-data-table_info">
                                    <thead>
                                            <tr>
                                             <tr role="row">
                                             <th class="sorting_asc" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 122px;">번호</th>
                                             <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 206px;">아이디</th>
                                             <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 84px;">문의내용</th>
                                             <th class="sorting" tabindex="0" aria-controls="bootstrap-data-table" rowspan="1" colspan="1" aria-label="Salary: activate to sort column ascending" style="width: 63px;">처리상태</th>
...
<tr>
	...
	<td style="text-align: center;"><a href="qnadetail.do?seq=${qna.seq }">
		${qna.title }</a></td>
	<td>${qna.wdate }</td>
 
	<td>
		<c:if test="${qna.result eq 0 }">답변대기</c:if>
...
<br><a href="qnawrite.do">글쓰기</a><a href="logout.do">로그아웃</a><br>
