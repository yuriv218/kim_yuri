			...
			<div class="animated fadeIn">
				<div class="row">
									...
									<div class="card-body card-block">
											...
											<div class="row form-group">
												...
												<div class="col-12 col-md-10">
													<input type="text" name="id" readonly="readonly" value="${qna.id }" class="form-control">
												</div>
											</div>
											<div class="row form-group">
												<div class="col col-md-2">
												...
												<div class="col-12 col-md-10">
													<input type="text" name="title"
														 class="form-control" readonly="readonly" value="${qna.title }">
												</div>
											</div>
											...
											<div class="row form-group">
												...
												<div class="col-12 col-md-10">
													<textarea name="content" id="textarea-input"
														rows="9" class="form-control" readonly="readonly">${qna.content}</textarea>
												</div>
											</div>

										
										</div>
										<button type="submit" id="_btnLogin" class="btn btn-success">글쓰기</button>
										<a href="qnalist.do" class="btn btn-success">글목록</a>
					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">답변하기</strong>
							</div>

							<!-- Credit Card -->
							<form name="frmForm" id="_frmForm" method="post" action="qnareplyAf.do">
							<input type="hidden" name="seq"   value="${qna.seq}"/>
							<input type="hidden" name="par_id" value='${qna.id}' size="60"/>
							<div id="cardinfo">
								<div class="card-body">
									<div class="card-body card-block">
											<!--   <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal"> -->
											<div class="row form-group">
												...
												<div class="col-12 col-md-10">
													<input type="text" name="id" readonly="readonly" value="관리자" class="form-control">
												</div>
											</div>
											<div class="row form-group">
												<div class="col col-md-2">
										...
										<button type="submit" id="_btnReply" class="btn btn-success">답글달기</button>
										<a href="qnalist.do" class="btn btn-success">글목록</a>
