					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">Update Goods</strong>
							</div>
							<div class="card-body">
                              ...
                              <form action="updategoodsAf.do" id="updategoodsform" name="_updategoodsform">
                              	<input type="hidden" name="seq" id="_seq" value="${stock.seq }">   
                                        ...
                                        <div class="form-group">
                                        	...
                                        	<input type="text" name="store" readonly="readonly" value="${stock.store }" size="60" class="form-control">
                                        </div>
		                                <div class="form-group">
		                                	<label for="company" class=" form-control-label">Product Name</label>
		                                	<input type="text" name="product" id="_product" size="60" value="${stock.product }" class="form-control">
		                                ...
		                                <div class="form-group">
		                                	...
		                                	<input type="text" name="price" id="_price" size="60" value="${stock.price }" class="form-control">
		                                </div>
                                      ...
                                      <script>
										$("#btnUpdate").click(function () {
											...
											{
												$("#updategoodsform").attr("action", "updategoodsAf.do").submit();
											}
										});
									</script>
